...
class TestQueryUrlMatching(JiraTest):
    issue_key = 'TAP-72'

    # test in date 20/6, 5/6 
    @pytest.mark.parametrize('field, value, from_time , end_time, expected_reuslt',
                            [
    ...
    def test_query_contains_matching_correctly(self,field, value, from_time , end_time, expected_reuslt):
    ...
    def test_query_regex_matching_correctly(self,field, value, from_time , end_time, expected_reuslt):
